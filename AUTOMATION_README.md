...
- **email**: Email portal (akan replace "LintasBandung33@gmail.com")
- **socialHandle**: Handle social media (akan replace "LintasBandung")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #047857 → custom)
  - **dark**: Warna gelap hitam (contoh: #064E3B → custom)
...
| `LintasBandung` | `siteName` (tanpa spaces) |
| `LintasBandung` | `socialHandle` |
| `LintasBandung33@gmail.com` | `email` |
| `#047857` (primary) | Warna primary dari config |
| `#064E3B` (dark) | Warna dark dari config |
| `#7F1F1F` (secondary) | Warna secondary dari config |
